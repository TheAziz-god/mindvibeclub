...
export default function ResourcesPage() {
  const resources: Resource[] = [
    ...
    },
    {
      ...
      category: "Confidence",
      icon: "🌱",
      href: "/resources/building-confidence",
    },
    {
      ...
      icon: "🎯",
      href: "/resources/healthy-study-habits",
    },
    {
      ...
      category: "Wellbeing",
      icon: "🧠",
      href: "/resources/understanding-emotions",
    },
    {
      ...
      icon: "🤝",
      href: "/resources/friendship-communication",
    },
    {
      ...
      category: "Lifestyle",
      icon: "☀️",
      href: "/resources/positive-daily-routines",
    },
  ];
    ...
    <main className="mindvibe-bg min-h-screen text-[#2B2B2B]">
      <section className="mx-auto max-w-6xl px-6 py-20">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {filteredResources.map((resource, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="rounded-3xl border border-[#E8D8C8] bg-[#FBF8F3]/90 p-7 shadow-xl transition duration-300 hover:border-[#7A4A8D] hover:shadow-2xl"
            >
        ...
        {filteredResources.length === 0 && (
          <p className="rounded-2xl bg-white/70 p-6 text-center font-semibold text-[#7A4A8D]">
